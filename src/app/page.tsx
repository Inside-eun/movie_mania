  ...
  return (
    <>
      ...
      <Header
        ...
        showWishlistView={showWishlistView}
        showEventsView={showEventsView}
        showInfoView={showInfoView}
        wishlistCount={wishlist.count}
        onGoHome={goToHome}
        onGoWishlist={goToWishlist}
        onGoEvents={goToEvents}
        onGoInfo={goToInfo}
      />
      ...
      {/* 히어로 배너 - ALL SCREENINGS 뷰에서만. 배너 자체가 로딩 중엔 동일한 높이의
          ...
          sm 이상에서는 본문과 동일한 max-w-4xl 컨테이너에 맞춰 좌우 여백을 통일한다. */}
      {isHomeView && (
        <div className="sm:container sm:mx-auto sm:max-w-4xl sm:px-4">
